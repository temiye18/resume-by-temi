...
const composePage = (theme: IResumeThemeOverrides) => ({
  ...
  fontSize: 10.5 * (theme.typeScale ?? 1),
  ...
  switch (variant) {
    ...
    case 'executive': {
      ...
      return {
        ...
        summary: { fontSize: 10.5 * scale, marginBottom: 4, lineHeight: 1.5, fontFamily: body },
        entryRow: { marginBottom: 0 },
        entryHeader: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 7.5, marginBottom: 1 },
        entryRole: { fontSize: 11 * scale, fontWeight: 700, fontFamily: body },
        entryCompany: { fontSize: 10 * scale, color: '#444', fontFamily: body },
        entryDates: { fontSize: 9 * scale, color: '#666', fontFamily: heading },
        bullet: { flexDirection: 'row', marginTop: 3, paddingLeft: 12 },
        bulletText: { flex: 1, fontSize: 10 * scale, lineHeight: 1.45, fontFamily: body },
        skillsLine: { flexDirection: 'row', marginBottom: 2 },
        skillsLabel: { fontSize: 9.5 * scale, fontWeight: 700, fontFamily: heading, marginRight: 4 },
        skillsText: { flex: 1, fontSize: 10 * scale, fontFamily: body },
        centerHeader: false,
    ...
    case 'compact': {
      ...
      return {
        ...
        summary: { fontSize: 9.5 * scale, marginBottom: 3, lineHeight: 1.45, fontFamily: body },
        entryRow: { marginBottom: 0 },
        entryHeader: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6, marginBottom: 1 },
        ...
        bulletText: { flex: 1, fontSize: 9.5 * scale, lineHeight: 1.4, fontFamily: body },
    ...
    case 'editorial': {
      ...
      return {
        ...
        summary: { fontSize: 10.5 * scale, marginBottom: 4, lineHeight: 1.55, fontFamily: body },
        entryRow: { marginBottom: 0 },
        entryHeader: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 9, marginBottom: 2 },
        entryRole: { fontSize: 11 * scale, fontWeight: 700, fontFamily: body },
        entryCompany: { fontSize: 10 * scale, fontStyle: 'italic', color: '#444', fontFamily: body },
        entryDates: { fontSize: 9 * scale, color: '#666', fontFamily: heading },
        bullet: { flexDirection: 'row', marginTop: 3, paddingLeft: 12 },
        bulletText: { flex: 1, fontSize: 10.5 * scale, lineHeight: 1.55, fontFamily: body },
        skillsLine: { flexDirection: 'row', marginBottom: 2 },

...
const Hero: FC = () => {
  ...
  return (
    <section
      className="relative px-6 pt-20 pb-24 sm:px-12 sm:pt-32 sm:pb-32 lg:pt-44 lg:pb-40"
    ...
    >
      <div className="mx-auto max-w-[1280px]">
        ...
        <m.div
          className="mt-12 grid gap-x-16 gap-y-8 lg:grid-cols-[1fr_auto] lg:items-end"
          initial={initial}
          animate="visible"
        ...
        <m.p
          className="mt-20 flex items-center gap-3 font-mono text-xs tabular-nums text-muted sm:mt-28"
          initial={initial}
          animate="visible"
          variants={heroFadeUpVariants}
